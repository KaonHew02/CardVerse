...
(() => {
    ...
    const EN = {
        ...
        'mj.rule9': 'Three seats have a floor: a hand worth fewer than 2番 cannot be declared at all, however finished it looks. Four seats have no minimum. There is no 混一色 at three seats — that box is dots and honours only, so one suit plus honours is what every hand already is, and a pattern every hand has is not a pattern.',
        ...
        'mj.fanUnit': 'Table stake', 'mj.fanUnitNote': 'What one 番 is worth. Three seats need 2番 to win, so this is what a hand actually pays.',
        ...
        'mj.fanTableFly': '飞 is wild — it stands in for any tile in this box and scores nothing by itself. A flower is set aside, replaced, and scores nothing. 混一色 is not on the list: three seats play dots and honours only, so every hand would have it.',
        ...
        'mj.fan.平胡': 'Basic hand — four melds and a pair, nothing on top.',
    ...
    const ZH = {
        ...
        'mj.rule9': '三人麻将有底线：不够 2 番就不能胡，牌型再漂亮也一样。四人麻将没有最低番数。三人不算混一色——那副牌只有筒子和字牌，一色加字牌本来就是每一手牌的样子，人人都有的东西不算番。',
        'mj.rule10': '10 番以上就是爆番，一律按 20 番结算，所以 11 番和 16 番赔一样多。三人自摸时两家都赔双倍；放铳时放铳的那家赔双倍，另一家赔正常。四人自摸时三家各赔一份，放铳则由打出那张牌的人全包。',
        'mj.fanUnit': '桌码', 'mj.fanUnitNote': '一番值多少。三人要 2 番才能胡，所以这就是一手牌真正的价钱。',
        ...
        'mj.fanTableFly': '飞是万能牌——可以当作这副牌里的任何一张，本身不加番。花牌摸到就补一张，也不计分。表里没有混一色：三人只有筒子和字牌，每手牌都是混一色，算它等于白送。',
        'mj.fanTableNoFly': '四人打整副 136 张——没有花牌，没有飞，也没有最低番数，和了就能胡。',
        'mj.fan.平胡': '四副面子加一对将，没有别的花样。',
