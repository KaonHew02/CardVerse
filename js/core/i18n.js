...
(() => {
    ...
    const EN = {
        ...
        'lami.rule4': 'Your first lay has to be a run of three. Until you have made it you are not on the table and cannot add to anybody else\'s melds.',
    ...
    const ZH = {
        ...
        'lami.rule4': '第一次打出必须是三张顺子。没打出之前你不算上桌，也不能往别人的牌组上加牌。',
