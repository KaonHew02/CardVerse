...
(() => {
    ...
    const EN = {
        ...
        'mj.rule12': 'A flower is never part of a hand: draw one and it is set aside and replaced. At three seats each flower is worth 1番, and going the whole hand without turning one is 无花, also 1番. Four seats have no flowers and no fly at all.',
        ...
        'mj.flowerFan': '{n}番', 'mj.flowerNone': '无花 +1番',
        ...
        'mj.fan.无花': 'No flowers — the whole hand, and not one flower turned.',
        'mj.fan.花': 'Flowers — 1番 each, and never part of the hand itself.',
    ...
    const ZH = {
        ...
        'mj.rule12': '花牌不算在手牌里，摸到就补一张。三人麻将每张花牌算 1 番；整手牌一张花都没有，是无花，也算 1 番。四人麻将没有花牌，也没有飞牌。',
        ...
        'mj.rule9': '三人麻将有底线：不够 5 番就不能胡，牌型再漂亮也一样。有刻子又没别的花样的牌是鸡胡，只有 1 番——底线就是让平胡、碰碰胡和花牌值得去凑。四人麻将没有最低番数。三人不算混一色——那副牌只有筒子和字牌，一色加字牌本来就是每一手牌的样子，人人都有的东西不算番；三人也不打七对子，七对子在这张桌上根本不算牌型。',
        ...
        'mj.flowerNoFan': '花不计番',
        'mj.flowerFan': '{n} 番', 'mj.flowerNone': '无花 +1 番',
        ...
        'mj.fanTableFly': '飞是万能牌——可以当作这副牌里的任何一张，本身不加番。花牌摸到就补一张，每张 1 番；一张花都没有是无花，也算 1 番。番种可以叠加，不互相吞：清一色加碰碰胡就是 3+3。表里没有混一色：三人只有筒子和字牌，每手牌都是混一色，算它等于白送。七对子这里也不算牌型。',
        'mj.fanTableNoFly': '四人打整副 136 张——没有花牌，没有飞，也没有最低番数，和了就能胡。',
        'mj.fan.鸡胡': '四副面子加一对将，没有别的花样。',
        'mj.fan.平胡': '四副面子全是顺子，一副刻子都没有。',
        'mj.fan.无花': '整手牌一张花都没摸到。',
        'mj.fan.花': '每张花牌 1 番，花牌本身不算在手牌里。',
