...
(() => {
    ...
    const EN = {
        ...
        'mj.rule8': 'One 番 is one point and a point is the table stake. 自摸 is paid by everyone; a discard is paid by whoever threw it. The dealer pays and collects double, and keeps the seat by winning.',
    ...
    const ZH = {
        ...
        'mj.rule8': '一番算一点，一点就是桌上的注码。自摸大家一起赔，放铳由打出那张牌的人一个人赔。庄家赔双收双，赢了继续坐庄。',
 'out.win': '赢',
