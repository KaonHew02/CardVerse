...
(() => {
    ...
    const EN = {
        ...
        'lami.noHome': 'Not enough to lay on its own, and nothing on the table takes it either. A run wants the same suit running on from one of its ends; a set wants the same number, and it is already full at four.',
        'lami.allJokers': 'Jokers cannot stand on their own — a meld needs real cards.',
        'lami.nextMeld': 'Another one ({n}/{of})',
        'lami.setSize': 'A set is three or four of one number — any suits, and two of the same suit is fine. You have too many or too few.',
        ...
        'lami.rule2': 'A run is three or more of one suit in order — ♣3 ♣4 ♣5. A set is three or four of one number and the suits do not matter — ♣7 ♦7 ♥7, and ♣7 ♣7 ♦7 just as well, because the box holds two of every card. The ace is high, so Q-K-A is a run and A-2-3 is not.',
    ...
    const ZH = {
        ...
        'lami.noHome': '张数不够自己成组，桌上也没有哪一组吃得下。顺子要同花、接在头尾连号；斩牌要同点，而且那一组还没满四张。',
        'lami.allJokers': '鬼牌不能单独成组——一组里要有真牌。',
        'lami.nextMeld': '换一组（{n}/{of}）',
        'lami.setSize': '斩牌是三张或四张同点的牌——花色随便，两张一样的花色也行。你选的张数不对。',
        ...
        'lami.rule2': '顺子是同花色三张以上连着的牌，例如 ♣3 ♣4 ♣5。斩牌是三或四张同点数的牌，花色不限，例如 ♣7 ♦7 ♥7，♣7 ♣7 ♦7 也算——整副牌每张都有两张。A 算最大，所以 Q-K-A 是顺子，A-2-3 不是。',
