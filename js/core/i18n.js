...
(() => {
    ...
    const EN = {
        ...
        'game.bullbull': '斗牛', 'game.bullbull.blurb': 'Five cards. Three make ten, the other two make the bull.',
        /* 斗牛 */
        'bb.bull0': '牛牛', 'bb.bull1': '牛一', 'bb.bull2': '牛二', 'bb.bull3': '牛三',
        'bb.bull4': '牛四', 'bb.bull5': '牛五', 'bb.bull6': '牛六', 'bb.bull7': '牛七',
        'bb.bull8': '牛八', 'bb.bull9': '牛九', 'bb.noBull': '无牛',
        'bb.baby': '宝宝·{n}',
        'bb.FIVE_PIC': '五个 Pic', 'bb.PIC_BLACK_ACE': 'Pic + Black Ace',
        'bb.times': '×{n}',
        'bb.waiting': '{name} is betting…',
        'bb.showing': 'Turning them over…',
        'bb.against': 'The dealer has {hand}.',
        'bb.detail': 'Dealer {hand}',
        'bb.rule1': 'Five cards each, and the dealer takes five too. Every seat is settled against the dealer and against nobody else.',
        'bb.rule2': 'An ace counts one, a ten and every picture card counts ten, and the rest count their face.',
        'bb.rule3': 'Find three cards that add to 10, 20 or 30. The last digit of the other two is your bull: a ten and a one make 牛一, and a round ten makes 牛牛. If no three cards make a multiple of ten, the hand is 无牛.',
        'bb.rule4': '宝宝 is a valid hand whose other two cards are the same value. Pic + Black Ace is a valid hand whose other two are a picture card and the ace of spades or clubs. Five picture cards is 五个 Pic, and beats everything.',
        'bb.rule5': 'The order runs 五个 Pic, Pic + Black Ace, 牛牛, then every 宝宝 by its bull, then 牛九 down to 牛一, then 无牛. Two hands that rank the same push and the bet comes back.',
        'bb.rule6': 'The hand you win with sets the size of it: 五个 Pic pays five times the bet, Pic + Black Ace four, 牛牛 and 宝宝 three, 牛七 to 牛九 two, and everything else one. The dealer\'s hand does the same to you.',
        'bb.rule7': 'There is nothing to decide after the bet. Five cards is the whole hand, which is the game rather than something missing from it.',

        'game.mahjong': 'Mahjong', 'game.mahjong.blurb': 'Draw, meld, discard. Four melds and a pair — three seats or four.',
        'game.lami': 'Lami', 'game.lami.blurb': 'Rummy on mahjong tiles. Runs, sets, jokers — empty your rack.',
        'game.dice': '骰子', 'game.dice.blurb': 'Three dice. Back 大, 小 or 围骰 and watch them land.',
        'game.roulette': 'Roulette Party', 'game.roulette.blurb': 'Spin. Risk. Survive. Three hearts each and one slot in six that bites.',
        /* Roulette Party */
        'rr.spin': '🔄 Spin', 'rr.pull': '🎯 Pull', 'rr.respin': '🔄 Re-spin',
        'rr.click': 'CLICK!', 'rr.bang': 'BANG!', 'rr.lucky': 'LUCKY!', 'rr.trap': 'TRAP!',
        'rr.points': 'points', 'rr.hpLost': '−{n} ❤️', 'rr.blocked': '🛡️ blocked',
        'rr.score': '⭐ {n}', 'rr.eliminated': 'ELIMINATED',
        'rr.left': '{n} slots left',
        'rr.shield': '🛡️ Shield', 'rr.double': '💢 Double', 'rr.lucky2': '✨ Lucky',
        'rr.ev.shield': '🛡️ Shield — the next hit is blocked',
        'rr.ev.double': '💢 Double damage — the next hit costs two',
        'rr.ev.lucky': '✨ Lucky spin — the next safe slot pays 50',
        'rr.ev.reverse': '🔁 Reverse — the order turns around',
        'rr.yourSpin': 'Your turn. Give it a spin.',
        'rr.yourPull': 'It has stopped. Pull, or spin once more.',
        'rr.spinNote': 'The slot is decided when you spin, and hidden until you pull.',
        'rr.pullNote': 'A re-spin is another draw from the same slots — it changes nothing but your nerve. One per turn.',
        'rr.turnOf': '{name} · round {n}',
        'rr.wins': '{name} is the last one standing!',
        'rr.survived': 'last one standing · {n} points',
        'rr.knockedOut': 'knocked out · {n} points',
        'rr.detail': '{name} survived {n} rounds on {s} points',
        'rr.detailNone': 'Nobody was left standing',
        'rr.rule1': 'A party game on an abstract six-slot spinner. Nothing here is a weapon — the slots are coloured squares with points attached, and every effect is hearts, points and animation.',
        'rr.rule2': 'Two to eight players, three ❤️ each. Lose them all and you are out. Last one standing wins the pot.',
        'rr.rule3': 'On your turn, spin the device and then pull. What the spin lands on is decided the moment it stops and stays hidden until you pull it.',
        'rr.rule4': 'You get one re-spin a turn. It is another draw from the same slots, so it changes nothing but your nerve — which is why there is only one.',
        'rr.rule5': 'A slot is used up when it is opened, so the six run down and reload. One danger in six is a one-in-six chance on the first pull and a certainty by the sixth. The device also gets meaner as the rounds pass.',
        'rr.rule6': 'SAFE is +10, BONUS is +30, TRAP costs a heart, DANGER costs a heart and 20 points. Between rounds you might pick up a shield, doubled damage, a lucky spin, or the order reversing.',
        ...
        'dice.total': 'Total {n}',
        'dice.yourBet': 'Pick a side and stake it.',
        'dice.waiting': '{name} is betting…',
        'dice.backed': 'backed {side}',
        'dice.detail': '{dice} = {total} · {what}',
        'dice.rule1': 'Three dice, one to six each, thrown together. Add them up.',
        ...
        'lami.pass': 'Pass', 'lami.done': 'End turn',
        'lami.run': 'run', 'lami.set': 'set',
        'lami.yourTurn': 'Your turn — lay a meld, or take a tile.',
        'lami.keepGoing': 'Lay more if you can, then end your turn.',
        'lami.waiting': '{name} is thinking…',
        'lami.hint': 'Tap tiles to pick them up. Tap a meld on the table to add to it.',
        'lami.notAMeld': 'Those tiles are not a run or a set.',
        'lami.emptyTable': 'Nothing on the table yet.',
        'lami.yours': '{n} tiles · {p} points',
        'lami.pool': '{n} left to draw',
        'lami.did.play': 'laid a meld', 'lami.did.extend': 'added a tile', 'lami.did.draw': 'took one',
        'lami.left': '{n} tiles · {p} points', 'lami.wentOut': 'went out — nothing left',
        'lami.detailOut': '{name} emptied their rack',
        'lami.detailStall': 'Nobody could move · {name} held the fewest at {p}',
        'lami.rule1': 'Rummy played on mahjong tiles: four suits of 1 to 13, two of every tile, and two jokers. Nothing from ordinary mahjong applies here — no chow, no pung, no 番.',
        'lami.rule2': 'A run is three or more of one suit in order — ♣3 ♣4 ♣5. A set is three or four of one number in different suits — ♣7 ♦7 ♥7.',
        'lami.rule3': 'A joker stands in for whatever a meld is missing, but it cannot stand on its own: the meld it completes has to be a real one.',
        'lami.rule4': 'On your turn, lay as many melds as you can and add whatever fits to what is already on the table. If you lay nothing at all, take one tile and pass it on.',
        'lami.rule5': 'Everyone throws to see who opens the first round, highest wins, and a tie throws again. After that, whoever won the last round opens the next one.',
        'lami.rule6': 'The round ends when somebody empties their rack, or when a full lap goes by with nobody able to move. Ending with tiles in hand is normal, not a failure.',
        'lami.rule7': 'Whatever is left in your hand counts against you — face value, and thirty for a joker. Everyone pays their points at the table stake and the smallest hand takes the lot.',
    ...
    const ZH = {
        ...
        'game.bullbull': '斗牛', 'game.bullbull.blurb': '五张牌。三张凑十，剩两张算牛。',
        'bb.bull0': '牛牛', 'bb.bull1': '牛一', 'bb.bull2': '牛二', 'bb.bull3': '牛三',
        'bb.bull4': '牛四', 'bb.bull5': '牛五', 'bb.bull6': '牛六', 'bb.bull7': '牛七',
        'bb.bull8': '牛八', 'bb.bull9': '牛九', 'bb.noBull': '无牛',
        'bb.baby': '宝宝·{n}',
        'bb.FIVE_PIC': '五个 Pic', 'bb.PIC_BLACK_ACE': 'Pic + 黑 A',
        'bb.times': '×{n}',
        'bb.waiting': '{name} 下注中…',
        'bb.showing': '开牌中…',
        'bb.against': '庄家是{hand}。',
        'bb.detail': '庄家 {hand}',
        'bb.rule1': '每人五张，庄家也是五张。每一家只跟庄家比，不跟别人比。',
        'bb.rule2': 'A 算 1，10 和公仔牌都算 10，其余按牌面算。',
        'bb.rule3': '从五张里找三张加起来是 10、20 或 30。剩下两张相加取个位数就是牛几：10 加 1 是牛一，刚好整十就是牛牛。凑不出十的倍数就是无牛。',
        'bb.rule4': '剩下两张点数一样就是宝宝。剩下两张是一张公仔加黑桃 A 或梅花 A，就是 Pic + 黑 A。五张全是公仔就是五个 Pic，最大。',
        'bb.rule5': '大小顺序：五个 Pic、Pic + 黑 A、牛牛，然后是宝宝（牛数越大越前），再来牛九到牛一，最后无牛。一样大就和局退回注码。',
        'bb.rule6': '赢的那手牌决定倍数：五个 Pic 五倍，Pic + 黑 A 四倍，牛牛和宝宝三倍，牛七到牛九两倍，其余一倍。庄家赢你的时候也一样算。',
        'bb.rule7': '下注之后就没有别的可以决定了。五张牌就是全部，这是玩法，不是漏了什么。',

        'game.mahjong': '麻将', 'game.mahjong.blurb': '摸牌、吃碰、打牌。四副面子加一对将，三人或四人。',
        'game.lami': '拉米', 'game.lami.blurb': '麻将牌玩的拉米。顺子、同点、鬼牌——把手牌打完。',
        'game.dice': '骰子', 'game.dice.blurb': '三颗骰子。押大、小或围骰，看它停在哪。',
        'game.roulette': '轮盘派对', 'game.roulette.blurb': '转、赌、活下来。每人三颗心，六格里有一格会咬人。',
        'rr.spin': '🔄 转', 'rr.pull': '🎯 开', 'rr.respin': '🔄 再转一次',
        'rr.click': '咔！', 'rr.bang': '砰！', 'rr.lucky': '走运！', 'rr.trap': '中招！',
        'rr.points': '分', 'rr.hpLost': '−{n} ❤️', 'rr.blocked': '🛡️ 挡下了',
        'rr.score': '⭐ {n}', 'rr.eliminated': '已淘汰',
        'rr.left': '还剩 {n} 格',
        'rr.shield': '🛡️ 护盾', 'rr.double': '💢 双倍', 'rr.lucky2': '✨ 幸运',
        'rr.ev.shield': '🛡️ 护盾——下一次伤害挡下',
        'rr.ev.double': '💢 双倍伤害——下一次扣两颗心',
        'rr.ev.lucky': '✨ 幸运一转——下一格安全给 50 分',
        'rr.ev.reverse': '🔁 反转——出场顺序倒过来',
        'rr.yourSpin': '轮到你了，转一下。',
        'rr.yourPull': '停了。可以开，也可以再转一次。',
        'rr.spinNote': '转停的那一刻结果就定了，开之前看不到。',
        'rr.pullNote': '再转一次只是从同样的格子里重新抽一次，机率一点没变，纯粹壮胆。每回合一次。',
        'rr.turnOf': '{name} · 第 {n} 回合',
        'rr.wins': '{name} 撑到最后！',
        'rr.survived': '撑到最后 · {n} 分',
        'rr.knockedOut': '被淘汰 · {n} 分',
        'rr.detail': '{name} 撑过 {n} 回合，{s} 分',
        'rr.detailNone': '没有人撑到最后',
        'rr.rule1': '一个用抽象六格转盘玩的派对游戏。这里没有武器——格子就是带分数的色块，所有效果都是心、分数和动画。',
        'rr.rule2': '2 到 8 人，每人三颗 ❤️。掉光就出局，最后剩下的那个人赢走底池。',
        'rr.rule3': '轮到你时先转，再开。转停的那一刻结果就定了，开之前谁也看不到。',
        'rr.rule4': '每回合可以再转一次。它只是从同样的格子里重新抽一次，机率完全没变——所以只给一次。',
        'rr.rule5': '开过的格子就用掉了，六格用完才重新装。六格里一格危险，第一次开是六分之一，到第六次就是必中。回合越多，转盘也越狠。',
        ...
        'dice.total': '共 {n} 点',
        'dice.yourBet': '选一边，下注。',
        'dice.waiting': '{name} 下注中…',
        'dice.backed': '押{side}',
        'dice.detail': '{dice} = {total} · {what}',
        'dice.rule1': '三颗骰子，每颗 1 到 6，一起摇，看总点数。',
        ...
        'lami.run': '顺子', 'lami.set': '同点',
        'lami.yourTurn': '轮到你了——打出一组，或者摸一张。',
        'lami.keepGoing': '还能打就继续，打完再结束回合。',
        'lami.waiting': '{name} 想牌中…',
        'lami.hint': '点牌来选。点桌上的牌组就能加上去。',
        'lami.notAMeld': '这几张凑不成顺子或同点。',
        'lami.emptyTable': '桌上还没有牌。',
        'lami.yours': '{n} 张 · {p} 分',
        'lami.pool': '还剩 {n} 张可摸',
        'lami.did.play': '打出一组', 'lami.did.extend': '加了一张', 'lami.did.draw': '摸了一张',
        'lami.left': '{n} 张 · {p} 分', 'lami.wentOut': '打完了——一张不剩',
        'lami.detailOut': '{name} 把手牌打完了',
        'lami.detailStall': '大家都走不动了 · {name} 最少，{p} 分',
        'lami.rule1': '用麻将牌玩的拉米：四种花色，每种 1 到 13，每张两副，另加两张鬼牌。普通麻将那一套在这里完全用不上——没有吃、碰、番。',
        'lami.rule2': '顺子是同花色三张以上连着的牌，例如 ♣3 ♣4 ♣5。同点是三或四张同点数、不同花色的牌，例如 ♣7 ♦7 ♥7。',
        'lami.rule3': '鬼牌可以顶替缺的那一张，但不能自己成组：它补出来的必须是真的一组牌。',
        'lami.rule4': '轮到你时，能打多少组就打多少组，也可以把牌加到桌上已有的组里。一张都打不出，就摸一张然后过。',
        'lami.rule5': '第一局大家掷骰子，点数最大的先出；一样大就再掷。之后每一局由上一局赢的人先出。',
        'lami.rule6': '有人把手牌打完，或者转了一整圈都没人能动，这一局就结束。手上还有牌很正常，不算输在规则上。',
        'lami.rule7': '手上剩的牌算你的分——按牌面算，鬼牌三十分。每人按桌码赔自己的分数，分最少的把这些全拿走。',
