...
(() => {
    ...
    const EN = {
        ...
        'lami.shelfRuns': 'Runs', 'lami.shelfSets': 'Sets — same number, different suits',
        ...
        'lami.noHome': 'Not enough to lay on its own, and nothing on the table takes it either. A run wants the same suit running on from one of its ends; a set wants the same number in a suit it has not already got.',
        'lami.allJokers': 'Jokers cannot stand on their own — a meld needs real cards.',
        'lami.setSameSuit': 'A set is one number in three DIFFERENT suits, and you have two {suit}. Swap one of them for another suit.',
        ...
        'lami.rule2': 'A run is three or more of one suit in order — ♣3 ♣4 ♣5. A set is three or four of one number in different suits — ♣7 ♦7 ♥7. The ace is high, so Q-K-A is a run and A-2-3 is not.',
    ...
    const ZH = {
        ...
        'lami.shelfRuns': '顺子', 'lami.shelfSets': '斩牌 · 同点不同花',
        'lami.shelfNone': '还没有',
        ...
        'lami.noHome': '张数不够自己成组，桌上也没有哪一组吃得下。顺子要同花、接在头尾连号；斩牌要同点，而且那个花色它还没有。',
        'lami.allJokers': '鬼牌不能单独成组——一组里要有真牌。',
        'lami.setSameSuit': '斩牌要同点不同花，你选了两张{suit}。换一张别的花色就行。',
        ...
        'lami.rule2': '顺子是同花色三张以上连着的牌，例如 ♣3 ♣4 ♣5。同点是三或四张同点数、不同花色的牌，例如 ♣7 ♦7 ♥7。A 算最大，所以 Q-K-A 是顺子，A-2-3 不是。',
