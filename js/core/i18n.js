...
(() => {
    ...
    const EN = {
        ...
        'res.tiles': "Everyone's tiles",
        'res.community': 'The board',
        'pk.board': 'The board',
        'res.again': 'Play again', 'res.lobby': 'Back to lobby',
        'res.peek': 'See the table', 'res.backToResult': '← Back to the result',
        'res.fanN': '{n}番',
        ...
        'set.pace': 'Table pace',
        'set.pace.relaxed': 'Relaxed', 'set.pace.normal': 'Normal', 'set.pace.fast': 'Fast',
        ...
        'room.seats': 'Seats', 'room.seatsN': '{n} players',
        'room.seatsNote': 'Some games are a different game at a different size — 麻将 at three seats plays its own 72-tile box with flowers and the 飞, and needs 5番 to win.',
        'room.code': 'Room code',
        ...
        'bb.baby': '宝宝·{n}',
        'bb.FIVE_PIC': '五个 Pic', 'bb.PIC_BLACK_ACE': 'Pic + ♠A',
        'bb.times': '×{n}',
        'bb.waiting': '{name} is betting…',
        'bb.showing': 'Turning them over…',
        'bb.dealing3': 'Three cards each…',
        'bb.dealing2': 'And the other two…',
        'bb.swapNote': 'A 3 counted as a 6, or a 6 as a 3',
        ...
        'bb.rule4': '宝宝 is a valid hand whose other two cards are the same value. Pic + ♠A is a valid hand whose other two are a picture card and the ace of spades. The spade only — A♣ is an ordinary ace. Five picture cards is 五个 Pic, and beats everything.',
        'bb.rule5': 'The order runs 五个 Pic, Pic + ♠A, 牛牛, then every 宝宝 by its bull, then 牛九 down to 牛一, then 无牛. Two hands that rank the same push and the bet comes back.',
        'bb.rule6': 'The hand you win with sets the size of it: 五个 Pic pays five times the bet, Pic + ♠A four, 牛牛 and 宝宝 three, 牛七 to 牛九 two, and everything else one. The dealer\'s hand does the same to you.',
        'bb.rule8': 'A 3 may be counted as a 6, and a 6 as a 3 — each one independently, and the hand is read whichever way comes out highest. A 无牛 that becomes a 牛七 because one 3 was counted as a 6 is a 牛七.',
        'bb.rule7': 'Three cards come out first, then the other two, and there is nothing to decide after the bet. Five cards is the whole hand, which is the game rather than something missing from it.',
        ...
        'game.roulette': '轮盘 Roulette', 'game.roulette.blurb': 'Cover the layout, then one ball settles the table. Single zero.',
        /* 轮盘 */
        'rl.place': 'Place', 'rl.clear': 'Clear the layout',
        'rl.spin': 'Spin the wheel', 'rl.pass': 'Sit this one out',
        'rl.chip': 'Chip', 'rl.yourBet': 'Cover the layout, then spin.',
        'rl.rolling': 'No more bets…',
        'rl.landed': '{n} {colour}',
        'rl.red': 'RED', 'rl.black': 'BLACK', 'rl.green': 'zero',
        'rl.odd': 'ODD', 'rl.even': 'EVEN', 'rl.low': '1–18', 'rl.high': '19–36',
        'rl.dozen1': '1st 12', 'rl.dozen2': '2nd 12', 'rl.dozen3': '3rd 12',
        'rl.house': 'The wheel',
        'rl.covered': '{n} spots',
        'rl.passed': 'Sat it out',
        'rl.staked': '🪙 {n} on the layout · {of} left',
        'rl.note': '{n} spots, {hits} paid',
        'rl.rule1': 'A single-zero wheel: 37 pockets, 0 to 36. There is no double zero — adding one would double the house’s edge, and that is the whole difference between the European and American games.',
        'rl.rule2': 'Cover as many spots as you like. Each chip is its own bet and each one is settled on its own, so a spin can pay you on three spots and take you on two.',
        'rl.rule3': 'A number pays 35 to 1. A dozen or a column pays 2 to 1. Red, black, odd, even, 1–18 and 19–36 all pay 1 to 1.',
        'rl.rule4': 'Zero is not red, not black, not odd, not even, not low and not high. It takes every outside bet on the table — that one rule is the edge on all of them.',
        'rl.rule5': 'Every bet here returns the same −2.70%. One pocket in 37 belongs to the house, and each price above is the fair inverse of its own chance with that pocket held back. No spot on the layout is better than another.',
        'rl.rule6': 'Everyone covers the layout in turn, then one ball settles the whole table. Nobody is playing against anybody else — you are all playing the wheel.',
        'rl.rule7': 'Splits, corners, streets and lines are real bets but are not on this table yet. Straight numbers, dozens, columns and the even-money spots are.',
        ...
        'lami.pass': 'Pass',
        'lami.jokerPick': 'Your joker could be either card — pick the run you meant.',
        'lami.jokerOut': '🃏 Spend a joker', 'lami.fold': 'Fold',
        'lami.did.joker': 'spent a joker', 'lami.did.fold': 'folded',
        'lami.folded': 'Folded · {n} tiles, {p} points',
        'lami.heaven': '天胡 — dealt in melds, nothing left over',
        'lami.pieces': '{n} pcs', 'lami.piecesNone': 'none dealt',
        'lami.piecesDealt': '{n} pcs dealt',
        'lami.arrange': 'Sort:', 'lami.arrangeRun': 'by run', 'lami.arrangeSet': 'by number',
        'lami.mustRun': 'Your first lay has to be a run of three.',
        'lami.mustOpen': 'You are holding a run, so your opening lay is not optional — lay it. No folding, no spending a joker to skip.',
        'lami.run': 'run', 'lami.set': 'set',
        'lami.shelfRuns': 'Runs', 'lami.shelfSets': 'Sets — same number',
        'lami.shelfNone': 'none yet',
        'lami.yourTurn': 'Your turn — put something down, or you are out of the hand.',
        'lami.waiting': '{name} is thinking…',
        'lami.hint': 'Tap tiles to pick them up. Any meld on the table that lights up will take them — tap it to put them there.',
        'lami.dragHint': 'Hold a tile to drag it — along the rack to rearrange, or onto a meld on the table to add it there.',
        'lami.notAMeld': 'Those tiles are not a run or a set.',
        'lami.tooFew': 'A meld is three cards at least.',
        'lami.oneAlone': '{card} on its own would go onto a meld — but it is picked together with cards that fit nothing. Tap the others again to unpick them, then tap the meld.',
        'lami.noHome': 'Not enough to lay on its own, and nothing on the table takes it either. A run wants the same suit running on past one of its ends — a joker already standing in the run keeps its place, so the tile it stands for cannot go there. A set wants the same number, and takes as many as you have.',
        'lami.allJokers': 'Jokers cannot stand on their own — a meld needs real cards.',
        'lami.nextMeld': 'Another one ({n}/{of})',
        'lami.setSize': 'A set is three or more of one number — any suits, and two of the same suit is fine. You have too few.',
        'lami.runSameRank': 'A run cannot hold two of the same card, and you have two {rank}s — there are two of every card in the box.',
        'lami.runGap': 'One suit, but the numbers do not run on. A run is consecutive; a joker can fill a hole in the middle.',
        'lami.pickMeld': 'The lit melds will take these — tap the one you want and they go straight on it, or drag the tile there.',
        'lami.leftPoints': 'Held · {p} points', 'lami.nothingLeft': 'nothing',
        ...
        'lami.rule1': 'Four seats, twenty tiles each, and that is the whole game: the box is four suits of 2 to A, two of every tile, plus jokers — and once it is dealt, nothing is drawn again. What you are holding is what you have.',
        'lami.rule2': 'A run is three or more of one suit in order — ♣3 ♣4 ♣5. A set is three or more of one number and the suits do not matter — ♣7 ♦7 ♥7, and ♣7 ♣7 ♦7 just as well, because the box holds two of every card; there is no limit to how many join it. The ace is high, so Q-K-A is a run and A-2-3 is not.',
        ...
        'lami.rule8': 'One more count runs underneath all of that, and it does not care who won. The jokers and aces you were dealt are pieces: one each, one more for being dealt both copies of the same ace, four more for one of every suit. It is counted on your opening twenty, not on what you are caught with — lay a joker or run an ace out and you keep the pieces either way. Everybody settles head to head with everybody, and whoever was dealt more collects half a stake for each piece of difference.',

        /* 麻将 */
        'mj.win': '胡 Win', 'mj.pung': '碰 Pung', 'mj.chow': '吃 Chow',
        'mj.kong': '杠 Kong', 'mj.pass': '过 Pass',
        'mj.seatTurn': 'Playing', 'mj.seatClaim': 'Deciding',
        'mj.chowPick': 'Pick the two tiles you want to make the run with.',
        'mj.chowHintOnly': 'Ringed tiles are one way to do it — take any two that work.',
        'mj.chowMany': 'Those two make more than one run. Which one?',
        'mj.chowNone': 'Those two do not make a run with that tile.',
        'mj.chowGo': '吃 with these', 'mj.chowBack': 'Back',
        ...
        'mj.rule12': 'A flower is never part of a hand: draw one and it is set aside and replaced. At three seats a flower is worth 1番 to the seat whose wind it carries (春 and 梅 belong to East, 夏 and 兰 to South, 秋 and 菊 to West, 冬 and 竹 to North) and a wind nobody is sitting on pays whoever turns it. Going a whole hand without turning one at all is 无花, which is a limit hand and settles at 爆番. Every hand starts on 无花 and holds it until its first flower. Four seats have no flowers and no fly at all.',
        ...
        'mj.rule5': 'Honours never form a chow — there is no run of winds. A kong takes four tiles off the table, so it draws a replacement, and there is no kong once the wall is dry. Adding a fourth tile to a pung already on the table is offered around first: anyone whose hand that tile finishes may take it (抢杠).',
        ...
        'mj.rule9': 'Three seats have a floor: a hand worth fewer than 5番 cannot be declared at all, however finished it looks. A hand with a triplet in it and nothing else going on is 鸡胡, 1番, so the floor is what makes 平胡, 碰碰胡 and the flowers worth building towards. Nothing there is paid for how the hand arrived — 自摸 and 门清 score nothing at three seats. Four seats have no minimum and still pay both. There is no 混一色 at three seats — that box is dots and honours only, so one suit plus honours is what every hand already is — and no 七对子 either: seven pairs is not a hand at that table.',
        ...
        'mj.myFlowers': 'Your flowers ({n})', 'mj.noFlowers': 'No flowers yet',
        'mj.flowerNoFan': 'flowers score 0番',
        'mj.flowerFan': '{n}番', 'mj.flowerNone': '无花 · 爆番',
        'mj.draw': '摸牌 Draw', 'mj.yourDraw': 'Your go — take a tile. {n} left in the wall.',
        'mj.drawMode': 'Drawing', 'mj.drawAuto': 'Auto', 'mj.drawManual': '摸牌 by hand',
        'mj.drawModeNote': 'Who takes the tile off the wall on your turn. Same wall either way — on 摸牌 you press for it.',
        'mj.sheetThrown': 'Thrown ({n})', 'mj.sheetNothing': 'Nothing thrown yet',
        'mj.sheetFlowers': 'Flowers ({n}) · {fan}番',
        'mj.fanNow': 'Hand is worth', 'mj.fanDone': 'This hand pays',
        'mj.fanNeed': '{n} short', 'mj.fanNowNone': 'Nothing counting yet',
        'mj.short': 'A winning hand — but {have}番 against a {need}番 minimum. Keep building.',
        'mj.bao': '💥 爆番, paid at {n}番',
        'mj.shuffling': '洗牌 · SHUFFLING',
        'mj.fanN': '{n}番', 'mj.sort': 'Sort',
        'mj.yourRob': '抢杠 — that tile is going into a kong. Take it, or let it go.',
        'mj.robWin': '抢杠', 'mj.robbedOff': 'Robbed on a 加杠',
        'mj.afterClaim': 'These tiles are a winning hand — but you took that one.',
        'mj.afterClaimNote': 'A 碰 or a 吃 is not a 自摸. Throw a tile; you may 胡 on the next one that fits, or on your next draw.',
        'mj.dragHint': 'Drag a tile to move it — your hand stays in the order you put it in.',
        'mj.whyWin': 'You can 胡. This is the hand:',
        'mj.whyShortTitle': 'The hand is finished, but it is short:',
        'mj.whyShort': 'needs {n} more 番',
        'mj.whyFly': 'A ringed tile is one of your 飞, counted as that tile.',
        'mj.fanTable': 'Fan table',
        'mj.fanTableHead': '{n} seats · {min}番 minimum to 胡 · {bao}番 or more settles at {paid}番 · 🪙{unit} a 番',
        'mj.fanTableFly': '飞 is wild — it stands in for any tile in this box and scores nothing by itself. A flower is set aside and replaced, and pays 1番 each; turning none all hand is 无花, a limit hand that settles at 爆番. 自摸 and 门清 are not paid here. Patterns stack rather than swallow one another, so 清一色 with 碰碰胡 is 3+3. 混一色 is not on the list — three seats play dots and honours only, so every hand would have it — and seven pairs is not a hand here at all.',
        'mj.fanTableNoFly': 'Four seats play the full 136 tiles — no flowers, no fly, and no minimum: any winning hand may be declared.',
        /* What each 番 means. The names are the ones the table uses, and a
         * player who has just been paid or charged for one has nowhere else
         * to find out what it was. */
        'mj.fan.鸡胡': 'Chicken hand — four melds and a pair, and nothing else to say about it.',
        'mj.fan.平胡': 'All sequences — four runs and a pair, not one triplet among them.',
        'mj.fan.无花': 'No flowers — a whole hand without turning one. A limit hand: it settles at 爆番.',
        'mj.fan.花': 'Flowers — 1番 each, and only the ones numbered for your own wind. Never part of the hand itself.',
        'mj.fan.箭刻': 'Dragons — 1番 for each triplet of 中, 发 or 白. They belong to nobody, so they pay everybody.',
        'mj.fan.风刻': '圈风 — the round is 东, so a 东 triplet pays whoever collects it. So does a wind nobody is sitting on (北 at three seats).',
        'mj.fan.门风': 'Your own wind — 1番 for a triplet of the wind you are sitting on, on top of the above. 东东东 in the 东 seat is both, and pays 2番.',
        'mj.dealerRun': '连{n}庄', 'mj.dealerRunAt': '{name} · 连{n}庄',
        'mj.fan.天胡': '天胡 — the dealer goes out on the tiles they were dealt.',
        'mj.fan.地胡': '地胡 — out on the very first discard the dealer makes.',
        'mj.fan.自摸': 'Self-draw — you drew the winning tile yourself.',
        'mj.fan.门清': 'Concealed — nothing in it was claimed from a discard.',
        'mj.fan.碰碰胡': 'All triplets — every meld a pung or a kong, no runs.',
        'mj.fan.混一色': 'Half flush — one suit plus honours and nothing else.',
        'mj.fan.七对子': 'Seven pairs, instead of four melds and a pair.',
        'mj.fan.小三元': 'Small dragons — two dragon triplets, the third the pair.',
        'mj.fan.清一色': 'Full flush — every tile one suit, no honours.',
        'mj.fan.豪华七对子': 'Seven pairs, one of them four of the same tile.',
        'mj.fan.清七对': 'Seven pairs, all of them in one suit.',
        'mj.fan.清碰': 'All triplets, all of them in one suit.',
        'mj.fan.字一色': 'All honours — nothing but winds and dragons.',
        'mj.fan.大三元': 'Big dragons — triplets of 中, 发 and 白.',
        'mj.fan.小四喜': 'Small winds — three wind triplets, the fourth the pair.',
        'mj.fan.大四喜': 'Big winds — triplets of all four winds.',
        'mj.fan.四杠子': 'Four kongs in the one hand.',
        'mj.fan.十三幺': 'Thirteen orphans — every terminal and honour, one twice.',
        ...
        'set.paceNote': 'how long the deal, the AI seats and the reveals take',
        ...
        'dg.house': 'The gate', 'dg.open': 'Shoot it', 'dg.shooting': 'Shooting…',
        'dg.pot': 'The pot', 'dg.potNote': 'everyone anted; take it or feed it',
        'dg.anteChip': 'ante {n}',
        'dg.ofPot': 'of the {n} in the middle',
        'dg.swing': 'Through / on a post:',
        'dg.callNote': 'Call anything from {lo} to {hi}. Through the gate takes it out of the pot; outside pays it in; a post pays double.',
        'dg.postRisk': '{n} land on a post — those pay double',
        'dg.cleared': 'Cleared out',
        'dg.potLeft': '{n} still in the middle',
        'dg.detailCleared': '{name} took the last of the pot — next hand antes afresh',
        'dg.detailPot': '{n} left in the middle · {gate}',
        ...
        'dg.rule6': 'The table shows how many cards left can still get through, and how many would land on a post, before you decide. Cards are not reshuffled until the pack runs down, so those figures move as the hand goes on.',
        'dg.rule7': 'Everybody antes into a pot in the middle. You call any amount up to what is in it: get through the gate and you take that much out, land outside and you pay it in, land on a post and you pay double. Passing costs nothing.',
        'dg.rule8': 'A hand is one lap of the table, and whatever is left in the middle stays there for the next one — 越叠越高. A fresh ante is only taken once somebody has cleared the pot out.',
        ...
        'slots.leave': 'Finish — show recap', 'slots.finished': 'Session finished.',
        'slots.leaveNote': 'Nothing to cash out: every win is already in your balance. This only closes the session and writes the recap.',
        ...
        'slots.payNote': 'The middle row is the payline. Three matching pays the table above; two matching pays the two rows below. Nothing else pays.',
        'slots.payPairs': 'Two on the line',
        'slots.payAnyTwo': 'Any other two the same',
        'slots.pair': 'Two the same — 🪙 {n} back',
        ...
        'slots.rule2': 'Three identical symbols on the line pay the table. Two identical pay your stake back, and 7️⃣ or 💎 pay double for two. Three different pay nothing.',
        ...
        'to.rules': 'Single deck · Dealer stands on 17 · 五龙 pays 2:1 · 15 may run',
        ...
        'to.rule7': '十五点可以跑 — if your first two cards total exactly 15, RUN leaves the hand and your stake comes straight back. No win, no loss, and the dealer plays on without you. Only on the opening two cards, and only on fifteen.',
    ...
    const ZH = {
        ...
        'res.peek': '看牌桌', 'res.backToResult': '← 返回结算',
        'res.fanN': '{n} 番',
        ...
        'set.fast': '快速动画',
        'set.pace': '牌桌节奏',
        'set.pace.relaxed': '慢', 'set.pace.normal': '正常', 'set.pace.fast': '快',
        ...
        'room.seats': '人数', 'room.seatsN': '{n} 人',
        'room.seatsNote': '有些游戏换个人数就是另一个游戏——三人麻将打的是自己那副 72 张，有花牌有飞，还要 5 番才能胡。',
        'room.code': '房号',
        ...
        'bb.bull8': '牛八', 'bb.bull9': '牛九', 'bb.noBull': '无牛',
        'bb.baby': '宝宝·{n}',
        'bb.FIVE_PIC': '五个 Pic', 'bb.PIC_BLACK_ACE': 'Pic + 黑桃 A',
        'bb.times': '×{n}',
        'bb.waiting': '{name} 下注中…',
        'bb.showing': '开牌中…',
        'bb.dealing3': '先派三张…',
        'bb.dealing2': '再派另外两张…',
        'bb.swapNote': '3 当 6 算，或者 6 当 3 算',
        'bb.against': '庄家是{hand}。',
        'bb.detail': '庄家 {hand}',
        ...
        'bb.rule4': '剩下两张点数一样就是宝宝。剩下两张是一张公仔加黑桃 A，就是 Pic + 黑桃 A。只算黑桃，梅花 A 是普通 A。五张全是公仔就是五个 Pic，最大。',
        'bb.rule5': '大小顺序：五个 Pic、Pic + 黑桃 A、牛牛，然后是宝宝（牛数越大越前），再来牛九到牛一，最后无牛。一样大就和局退回注码。',
        'bb.rule6': '赢的那手牌决定倍数：五个 Pic 五倍，Pic + 黑桃 A 四倍，牛牛和宝宝三倍，牛七到牛九两倍，其余一倍。庄家赢你的时候也一样算。',
        'bb.rule8': '3 可以当 6 算，6 也可以当 3 算，每张各自算，最后按最大的那个读法算。本来无牛，把一张 3 当 6 之后凑到牛七，那就是牛七。',
        'bb.rule7': '先派三张，再派另外两张。下注之后就没有别的可以决定了。五张牌就是全部，这是玩法，不是漏了什么。',
        ...
        'game.roulette': '轮盘', 'game.roulette.blurb': '下好注，一颗珠子结清全桌。单零轮盘。',
        'rl.place': '下注', 'rl.clear': '收回筹码',
        'rl.spin': '开转', 'rl.pass': '这局不下',
        'rl.chip': '筹码', 'rl.yourBet': '下好注，然后开转。',
        'rl.rolling': '不再下注…',
        'rl.landed': '{n} {colour}',
        'rl.red': '红', 'rl.black': '黑', 'rl.green': '零',
        'rl.odd': '单', 'rl.even': '双', 'rl.low': '1–18', 'rl.high': '19–36',
        'rl.dozen1': '第一打1–2', 'rl.dozen2': '第二打12', 'rl.dozen3': '第三打12',
        'rl.house': '轮盘',
        'rl.covered': '{n} 个位',
        'rl.passed': '这局没下',
        'rl.staked': '🪙 台上 {n} · 还剩 {of}',
        'rl.note': '下了 {n} 个位，中 {hits} 个',
        'rl.rule1': '单零轮盘：37 格，0 到 36。没有双零——加上双零庄家优势就翻倍，欧式和美式的区别就在这里。',
        'rl.rule2': '想下几个位都行。每一笔筹码都是独立的一注，各算各的，所以一转可以赔你三注、吃你两注。',
        'rl.rule3': '单号赔 35 倍。一打或一列赔 2 倍。红、黑、单、双、1–18、19–36 都是一赔一。',
        'rl.rule4': '零不是红、不是黑、不是单、不是双、不是小也不是大。它把所有外围注全收走——这一条就是外围注的庄家优势。',
        'rl.rule5': '这里每一种注的回报都是 −2.70%。37 格里有一格是庄家的，上面每个赔率都是扣掉那一格之后的公平赔率。台面上没有哪一个位比别的好。',
        'rl.rule6': '大家轮流下注，然后一颗珠子结清全桌。没有人在跟别人斗——大家都在跟轮盘斗。',
        'rl.rule7': '分注、角注、街注、线注都是真实的玩法，但这张台子还没有。现在可下的是单号、打、列和一赔一的外围注。',
        ...
        'lami.pass': '过',
        'lami.jokerPick': '这张鬼两种都能当——选你要的那种顺子。',
        'lami.jokerOut': '🃏 打一张鬼', 'lami.fold': '不要了',
        'lami.did.joker': '打了一张鬼', 'lami.did.fold': '不要了',
        'lami.folded': '已放弃 · 剩 {n} 张，{p} 分',
        'lami.heaven': '天胡——发到手就全部成组，一张不剩',
        'lami.pieces': '{n} 只', 'lami.piecesNone': '没有发到鬼牌和 A',
        'lami.piecesDealt': '发到 {n} 只',
        'lami.arrange': '排序：', 'lami.arrangeRun': '顺子', 'lami.arrangeSet': '同点',
        'lami.mustRun': '第一次打出必须是三张顺子。',
        'lami.mustOpen': '你手上有顺子——第一手不能不打，也不能打鬼混过去，把顺子打出来。',
        'lami.run': '顺子', 'lami.set': '同点',
        'lami.shelfRuns': '顺子', 'lami.shelfSets': '斩牌 · 同点',
        'lami.shelfNone': '还没有',
        'lami.yourTurn': '轮到你了——必须打出点东西，不然这一局就不要了。',
        'lami.waiting': '{name} 想牌中…',
        'lami.hint': '点牌来选。桌上亮起来的牌组吃得下你选的牌，点一下就加上去。',
        'lami.dragHint': '按住牌可以拖动——在手牌里拖是排序，拖到桌上的牌组就是加上去。',
        'lami.notAMeld': '这几张凑不成顺子或同点。',
        'lami.tooFew': '至少要三张才算一组。',
        'lami.oneAlone': '{card} 单独一张就加得上去——可是它跟凑不成组的牌一起选着。再点一下其他的牌取消选择，然后点那一组。',
        'lami.noHome': '张数不够自己成组，桌上也没有哪一组吃得下。顺子要同花、接在头尾往外连号——已经摆在顺子里的百搭占着位子，不能拿它代表的那张去换；斩牌要同点，张数不限。',
        'lami.allJokers': '鬼牌不能单独成组——一组里要有真牌。',
        'lami.nextMeld': '换一组（{n}/{of}）',
        'lami.setSize': '斩牌是三张以上同点的牌——花色随便，两张一样的花色也行。你选的张数不够。',
        'lami.runSameRank': '顺子里不能有两张一样的牌，你选了两张 {rank}——整副牌每张都有两张。',
        'lami.runGap': '花色是同一门，可是号码连不起来——顺子要连号，中间缺的可以用鬼牌补。',
        'lami.pickMeld': '亮起来的牌组吃得下这几张——点一下那组就直接加上去，也可以把牌拖过去。',
        'lami.leftPoints': '剩牌 · {p} 分', 'lami.nothingLeft': '没有',
        ...
        'lami.rule1': '四个人，一人二十张，整个游戏就是这么回事：一副牌是四种花色的 2 到 A，每张两副，再加鬼牌——发完就不再摸了。手上有什么就是什么。',
        'lami.rule2': '顺子是同花色三张以上连着的牌，例如 ♣3 ♣4 ♣5。斩牌是三张以上同点数的牌，花色不限、张数不限，例如 ♣7 ♦7 ♥7，♣7 ♣7 ♦7 也算——整副牌每张都有两张。A 算最大，所以 Q-K-A 是顺子，A-2-3 不是。',
        ...
        'lami.rule8': '还有一笔账在下面单算，跟谁赢没关系。发到手的鬼牌和 A 算“只”：一张一只，同一张 A 拿齐两副再加一只，四种花色的 A 拿齐再加四只。算的是开局那二十张，不是最后剩的——鬼牌照打，A 照出顺子，只数一样是你的。所有人两两对账，只多的向只少的收，每差一只半倍底。',

        'mj.win': '胡', 'mj.pung': '碰', 'mj.chow': '吃',
        'mj.kong': '杠', 'mj.pass': '过',
        'mj.seatTurn': '出牌中', 'mj.seatClaim': '要牌中',
        'mj.chowPick': '选两张你想用来组顺子的牌。',
        'mj.chowHintOnly': '圈起来的只是其中一种吃法——任意两张吃得成的都行。',
        'mj.chowMany': '这两张能组成不止一种顺子，要哪一种？',
        'mj.chowNone': '这两张跟那张牌组不成顺子。',
        'mj.chowGo': '就吃这两张', 'mj.chowBack': '返回',
        ...
        'mj.rule12': '花牌不算在手牌里，摸到就补一张。三人麻将的花牌认风位：春梅是东家的，夏兰是南家的，秋菊是西家的，冬竹是北家的，自己风位的花每张 1 番，别人的花不算；没人坐的那个风位（三人没有北）的花，谁摸到算谁的。整手牌一张花都没摸到是无花，算满贯，直接爆番。每一手牌开局都是无花，摸到第一张花才没了。四人麻将没有花牌，也没有飞牌。',
        ...
        'mj.rule5': '字牌不能吃——没有风的顺子。杠会拿走四张牌，所以要补一张；牌墙摸完了就不能再杠。给桌上的碰加第四张（加杠）之前会先问一圈：谁等的正是那张牌，可以抢杠胡。',
        ...
        'mj.rule9': '三人麻将有底线：不够 5 番就不能胡，牌型再漂亮也一样。有刻子又没别的花样的牌是鸡胡，只有 1 番——底线就是让平胡、碰碰胡和花牌值得去凑。牌怎么来的不算番：三人不算自摸，也不算门清。四人麻将没有最低番数，自摸门清照算。三人不算混一色——那副牌只有筒子和字牌，一色加字牌本来就是每一手牌的样子，人人都有的东西不算番；三人也不打七对子，七对子在这张桌上根本不算牌型。',
        ...
        'mj.myFlowers': '你的花（{n}）', 'mj.noFlowers': '还没有花',
        'mj.flowerNoFan': '花不计番',
        'mj.flowerFan': '{n} 番', 'mj.flowerNone': '无花 · 爆番',
        'mj.draw': '摸牌', 'mj.yourDraw': '轮到你摸牌了——牌墙还剩 {n} 张。',
        'mj.drawMode': '摸牌方式', 'mj.drawAuto': '自动', 'mj.drawManual': '自己摸',
        'mj.drawModeNote': '轮到你时，谁把牌从墙上拿下来。牌墙和顺序完全一样，只是自己摸要按一下。',
        'mj.sheetThrown': '打出（{n}）', 'mj.sheetNothing': '还没打过牌',
        'mj.sheetFlowers': '花（{n}）· {fan} 番',
        'mj.fanNow': '现在值', 'mj.fanDone': '这手牌可胡',
        'mj.fanNeed': '还差 {n} 番', 'mj.fanNowNone': '还没有番',
        'mj.short': '牌是和了——但只有 {have} 番，要 {need} 番才能胡。继续做大。',
        'mj.bao': '💥 爆番，按 {n} 番算',
        'mj.shuffling': '洗　牌　中',
        'mj.fanN': '{n} 番', 'mj.sort': '整理',
        'mj.yourRob': '抢杠——这张牌正要被拿去杠。你可以胡，也可以过。',
        'mj.robWin': '抢杠', 'mj.robbedOff': '加杠被抢',
        'mj.afterClaim': '这手牌是和了——但那张是你碰（吃）来的。',
        'mj.afterClaimNote': '碰和吃都不算自摸。先打一张，下一张合的牌或者自己摸到就可以胡。',
        'mj.dragHint': '按住牌可以拖动——手牌会保持你排好的顺序。',
        'mj.whyWin': '可以胡了。这手牌是这样的：',
        'mj.whyShortTitle': '牌型已经和了，但番数不够：',
        'mj.whyShort': '还差 {n} 番',
        'mj.whyFly': '有圈的那张是你的飞，当成这张牌算。',
        'mj.fanTable': '番种表',
        'mj.fanTableHead': '{n} 人麻将 · 最低 {min} 番才能胡 · {bao} 番以上按 {paid} 番算 · 一番 🪙{unit}',
        'mj.fanTableFly': '飞是万能牌——可以当作这副牌里的任何一张，本身不加番。花牌摸到就补一张，每张 1 番；一张花都没有是无花，算满贯直接爆番。这里不算自摸，也不算门清。番种可以叠加，不互相吞：清一色加碰碰胡就是 3+3。表里没有混一色：三人只有筒子和字牌，每手牌都是混一色，算它等于白送。七对子这里也不算牌型。',
        'mj.fanTableNoFly': '四人打整副 136 张——没有花牌，没有飞，也没有最低番数，和了就能胡。',
        'mj.fan.鸡胡': '四副面子加一对将，没有别的花样。',
        'mj.fan.平胡': '四副面子全是顺子，一副刻子都没有。',
        'mj.fan.无花': '整手牌一张花都没摸到。算满贯，直接爆番。',
        'mj.fan.花': '自己风位的花牌每张 1 番，别人的花不算。花牌本身不算在手牌里。',
        'mj.fan.箭刻': '中、发、白每一副刻子算 1 番。三元牌不属于任何人，所以谁碰到算谁的。',
        'mj.fan.风刻': '圈风算 1 番——这里圈风是东，所以东刻谁凑到算谁的。没人坐的那个风位（三人没有北）也一样。',
        'mj.fan.门风': '自己风位的风刻再算 1 番，跟上面叠加：东家的东刻是圈风加门风，一共 2 番。',
        'mj.dealerRun': '连{n}庄', 'mj.dealerRunAt': '{name}·连{n}庄',
        'mj.fan.天胡': '庄家发到手就胡，还没打过牌。',
        'mj.fan.地胡': '闲家胡庄家打出的第一张牌。',
        'mj.fan.自摸': '胡的那张牌是自己摸到的。',
        'mj.fan.门清': '整手牌没有吃碰过别人打出的牌。',
        'mj.fan.碰碰胡': '每副面子都是刻子或杠，没有顺子。',
        'mj.fan.混一色': '一种花色加字牌，别的花色一张都没有。',
        'mj.fan.七对子': '七组对子，不是四副面子加将。',
        'mj.fan.小三元': '两副三元刻子，第三种当将。',
        'mj.fan.清一色': '整手都是同一种花色，一张字牌都没有。',
        'mj.fan.豪华七对子': '七对子里有一组是四张一样的。',
        'mj.fan.清七对': '七对子，而且全是同一种花色。',
        'mj.fan.清碰': '碰碰胡，而且全是同一种花色。',
        'mj.fan.字一色': '全是风牌和三元牌。',
        'mj.fan.大三元': '中、发、白三副刻子都有。',
        'mj.fan.小四喜': '三副风刻，第四种风当将。',
        'mj.fan.大四喜': '东南西北四副刻子都有。',
        'mj.fan.四杠子': '一手牌里开了四个杠。',
        'mj.fan.十三幺': '十三张幺九字牌各一张，其中一张成对。',
 'out.win': '赢',
        ...
        'dg.offer': '射这道门，或者不射。',
        'dg.house': '龙门', 'dg.open': '射', 'dg.shooting': '射门中…',
        'dg.pot': '台面', 'dg.potNote': '大家放进去的，拿走或者喂它',
        'dg.anteChip': '底 {n}',
        'dg.ofPot': '台面上有 {n}',
        'dg.swing': '射中 / 撞柱：',
        'dg.callNote': '{lo} 到 {hi} 之间随你叫。射中就从台面拿走，射不中就赔进去，撞柱赔双倍。',
        'dg.postRisk': '{n} 张会撞柱 — 撞柱赔双倍',
        'dg.cleared': '被拿完了',
        'dg.potLeft': '台面还剩 {n}',
        'dg.detailCleared': '{name} 把台面拿完了 — 下一局重新放底',
        'dg.detailPot': '台面还剩 {n} · {gate}',
        ...
        'dg.rule6': '开牌前会显示剩下的牌里有几张能穿过去、几张会撞柱。牌打完之前不会重新洗，所以这些数字会随着这一局慢慢变。',
        'dg.rule7': '每个人先放底注到台面。轮到你时，台面有多少你就可以叫到多少：射中就从台面拿走那么多，射不中就赔进去，撞柱赔双倍。不射不用钱。',
        'dg.rule8': '一局就是绕桌一圈，台面剩下的钱留到下一局，越叠越高。要等到有人把台面拿完，才重新放底注。',

        'slots.spin': '开始', 'slots.spinning': '转动中…',
        'slots.tagline': '三轮 · 一线',
        'slots.credit': '余额', 'slots.meterBet': '下注', 'slots.meterWin': '中奖',
        'slots.leave': '结束 — 看总结', 'slots.finished': '本轮结束。',
        'slots.leaveNote': '没有什么要兑的：每一把赢的金币已经在你账上了。这个只是结束这一轮，写总结。',
        'slots.bet': '每次下注', 'slots.max': '最大',
        'slots.range': '每次 {lo}–{hi}',
        'slots.auto': '自动', 'slots.stopAuto': '停止自动（还剩 {n}）',
        'slots.autoStopped': '自动停止 — 金币不够了。',
        'slots.paytable': '赔率表',
        'slots.payNote': '中间那一行是中奖线。三个相同按上面的赔率，两个相同按下面那两行，其他都不赔。',
        'slots.payPairs': '一线上两个',
        'slots.payAnyTwo': '其他任意两个相同',
        'slots.pair': '两个相同 — 退回 🪙 {n}',
        ...
        'slots.rule2': '一线上三个相同按赔率表赔。两个相同退回注码，7️⃣ 或 💎 两个赔双倍。三个不同不赔。',
        ...
        'out.dragons': '五龙',
        'to.rules': '单副牌 · 庄家 17 点停牌 · 五龙赔 2:1 · 十五点可以跑',
        ...
        'to.rule7': '十五点可以跑 — 头两张牌刚好十五点，可以选择“跑”：退出这一局，注码全额拿回，不赢也不输，庄家继续开牌。只限头两张，只限十五点。',
