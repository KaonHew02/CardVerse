...
(() => {
    ...
    const EN = {
        ...
        'mj.fan.风刻': 'Your wind — 1番 for a triplet of the wind you are sitting on. A wind nobody is sitting on (北 at three seats) pays whoever collects it.',
    ...
    const ZH = {
        ...
        'mj.fan.风刻': '自己风位的风刻算 1 番。没人坐的那个风位（三人没有北），谁凑到算谁的。',
        'mj.dealerRun': '连{n}庄', 'mj.dealerRunAt': '{name}·连{n}庄',
