...
(() => {
    ...
    const EN = {
        ...
        'table.cards': '{n} cards',
        'table.dealer': 'Dealer',
        'table.rules': '{decks} decks · Dealer stands on 17 · Blackjack pays 3:2',
        'table.rulesSimple': 'Single deck · Dealer draws to 17 · Exactly 21 pays 3:2',
        ...
        'table.insuring': '{name} is deciding on insurance…',
        ...
        'table.ofCoins': 'of {n}',
        'act.hit': 'Hit', 'act.stand': 'Stand', 'act.double': 'Double',
        'act.split': 'Split', 'act.surrender': 'Surrender',
        'act.insure': 'Insure', 'act.noInsure': 'No insurance', 'act.bet': 'Bet',
        'act.insureHint': '{n} coins',
        ...
        'game.blackjack.blurb': 'Beat the dealer. Split, double, surrender.',
        'game.twentyone': '21',
        'game.twentyone.blurb': 'Hit or stand. Exactly 21 wins outright.',
        ...
        /* per-game stat labels */
        'x.blackjacks': 'Blackjacks', 'x.busts': 'Busts', 'x.doubles': 'Doubles',
        'x.splits': 'Splits', 'x.dealerBusts': 'Dealer busts seen', 'x.surrenders': 'Surrenders',
        'x.forfeits': 'Walked away', 'x.twentyones': 'Exact 21s', 'x.dealt21': 'Dealt 21',
        ...
        'achv.bj-first': 'Beat the House', 'achv.bj-first.desc': 'Win your first Blackjack hand.',
        'achv.bj-natural': 'Natural', 'achv.bj-natural.desc': 'Be dealt a blackjack.',
        'achv.bj-natural-25': 'Twenty-One Club', 'achv.bj-natural-25.desc': 'Be dealt 25 blackjacks.',
        'achv.bj-split-win': 'Divide and Conquer', 'achv.bj-split-win.desc': 'Win a hand after splitting.',
        'achv.bj-double-win': 'Double Trouble', 'achv.bj-double-win.desc': 'Win a hand after doubling down.',
        'achv.bj-wins-50': 'Card Counter', 'achv.bj-wins-50.desc': 'Win 50 Blackjack hands.',
        'achv.bj-wins-200': 'Blackjack Master', 'achv.bj-wins-200.desc': 'Win 200 Blackjack hands.',
        'achv.bj-streak-5': 'Dealer’s Nightmare', 'achv.bj-streak-5.desc': 'Win 5 Blackjack hands in a row.',

        /* achievements - 21 */
        'achv.to-first': 'Nice Round Number', 'achv.to-first.desc': 'Win your first game of 21.',
        'achv.to-exact': 'On the Nose', 'achv.to-exact.desc': 'Hit exactly 21.',
        'achv.to-exact-25': 'Sharpshooter', 'achv.to-exact-25.desc': 'Hit exactly 21 twenty-five times.',
        'achv.to-wins-50': 'Twenty-One Regular', 'achv.to-wins-50.desc': 'Win 50 games of 21.',
        'achv.to-streak-5': 'Five Alive', 'achv.to-streak-5.desc': 'Win 5 games of 21 in a row.',
    ...
    const ZH = {
        ...
        'table.cards': '剩 {n} 张',
        'table.dealer': '庄家',
        'table.rules': '{decks} 副牌 · 庄家 17 点停牌 · 黑杰克赔 3:2',
        'table.rulesSimple': '单副牌 · 庄家补到 17 点 · 正好 21 点赔 3:2',
        ...
        'table.ofCoins': '/ {n}',
        'act.hit': '要牌', 'act.stand': '停牌', 'act.double': '加倍',
        'act.split': '分牌', 'act.surrender': '投降',
        'act.insure': '买保险', 'act.noInsure': '不买保险', 'act.bet': '下注',
        'act.insureHint': '{n} 金币',
        ...
        'game.blackjack': '二十一点',
        'game.blackjack.blurb': '赢过庄家。可分牌、加倍、投降。',
        'game.twentyone': '21点',
        'game.twentyone.blurb': '要牌或停牌。正好 21 点直接赢。',
        ...
        'game.mahjong': '麻将', 'game.mahjong.blurb': '港式麻将。四副面子加一对将。',
        ...
        'x.blackjacks': '黑杰克次数', 'x.busts': '爆牌次数', 'x.doubles': '加倍次数',
        'x.splits': '分牌次数', 'x.dealerBusts': '庄家爆牌次数', 'x.surrenders': '投降次数',
        'x.forfeits': '中途离开', 'x.twentyones': '正好 21 点', 'x.dealt21': '发到 21 点',
        ...
        'achv.bj-first': '赢过庄家', 'achv.bj-first.desc': '赢下第一局二十一点。',
        'achv.bj-natural': '天生黑杰克', 'achv.bj-natural.desc': '发到一副黑杰克。',
        'achv.bj-natural-25': '二十一点俱乐部', 'achv.bj-natural-25.desc': '累计发到 25 副黑杰克。',
        'achv.bj-split-win': '分而胜之', 'achv.bj-split-win.desc': '分牌后赢下一局。',
        'achv.bj-double-win': '加倍好运', 'achv.bj-double-win.desc': '加倍后赢下一局。',
        'achv.bj-wins-50': '算牌人', 'achv.bj-wins-50.desc': '赢下 50 局二十一点。',
        'achv.bj-wins-200': '二十一点大师', 'achv.bj-wins-200.desc': '赢下 200 局二十一点。',
        'achv.bj-streak-5': '庄家的噩梦', 'achv.bj-streak-5.desc': '二十一点连胜 5 局。',

        'achv.to-first': '整数之美', 'achv.to-first.desc': '赢下第一局 21 点。',
        'achv.to-exact': '不偏不倚', 'achv.to-exact.desc': '拿到正好 21 点。',
        'achv.to-exact-25': '神射手', 'achv.to-exact-25.desc': '累计 25 次拿到正好 21 点。',
        'achv.to-wins-50': '21 点常客', 'achv.to-wins-50.desc': '赢下 50 局 21 点。',
        'achv.to-streak-5': '五连不倒', 'achv.to-streak-5.desc': '21 点连胜 5 局。',
